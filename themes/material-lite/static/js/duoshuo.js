...
! function(e, t, s) {
    ...
    if (o.extend = function(e, t) {
        ...
        et.commentList = function(e) {
            ...
            var t = '<div class="ds-dialog"><div class="ds-dialog-inner mdl-card"><div class="ds-dialog-header"><a class="ds-dialog-close mdl-button mdl-js-button mdl-button--icon mdl-button--colored" href="javascript:void(0)" title="关闭"><i class="material-icons">close</i></a></div><div class="ds-dialog-body">' + e + '</div></div></div>';
            return t
            ...
            return t += "</span>", t += "</div>", t += '<button class="ds-post-button mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-button--colored mdl-button--icon" type="submit">' + z.post + '</button><div class="ds-toolbar-buttons">', e.options.use_smilies && (t += '<a class="ds-toolbar-button ds-add-emote" title="插入表情"></a>'), e.options.use_images && e.options.parse_html_enabled && (t += '<a class="ds-toolbar-button ds-add-image" title="插入图片"></a>'), t += "</div></div>", t += "</form></div>"
