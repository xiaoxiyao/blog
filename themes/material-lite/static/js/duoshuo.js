...
! function(e, t, s) {
    ...
    if (o.extend = function(e, t) {
        ...
        et.commentList = function(e) {
            ...
            var t = '<div class="ds-dialog"><div class="ds-dialog-inner mdl-card"><div class="mdl-card__title"></div><div class="mdl-card__supporting-text">' + e + '</div><div class="mdl-card__menu"><a class="ds-dialog-close mdl-button mdl-js-button mdl-button--icon mdl-button--colored" href="javascript:void(0)" title="关闭"><i class="material-icons">close</i></a></div></div></div>';
            return t
