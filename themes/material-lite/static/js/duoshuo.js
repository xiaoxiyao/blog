...
! function(e, t, s) {
    ...
    if (o.extend = function(e, t) {
        ...
        et.commentList = function(e) {
            ...
            return t += "</span>", t += "</div>", t += '<button class="ds-post-button mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-button--colored mdl-button--icon" type="submit">' + z.post + '</button><div class="ds-toolbar-buttons">', e.options.use_smilies && (t += '<a class="ds-toolbar-button ds-add-emote mdl-button mdl-js-button mdl-button--icon mdl-button--colored" title="插入表情"><i class="material-icons">mood</i></a>'), e.options.use_images && e.options.parse_html_enabled && (t += '<a class="ds-toolbar-button ds-add-image" title="插入图片"></a>'), t += "</div></div>", t += "</form></div>"
